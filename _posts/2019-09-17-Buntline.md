...
In general, the greater the increase in barrel length, the greater the gain in accuracy and range for a firearm. Though there is a optimal length of barrel and barrels that are two long will actually cause a decrease in range unless special powders are used.
